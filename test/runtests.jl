...
# !!! Main.UserApp is configured as an alias for Main.Gauth and you might encounter it in some tests
using Main.Gauth, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Gauth tests" begin
  @includetests ARGS
end
